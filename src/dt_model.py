...
class DecisionTree():
	...
	def createModel(self):
		...
		self.model = make_pipeline(CountVectorizer(), DecisionTreeClassifier())
	...
	def modelEvaluation(self, X_test, y_test):
		...
		self.score = round(self.model.score(X_test, y_test) ,4)* 100
	...
	def visualRepresentation(self):
		...
		ax = plt.axes()
		ax.set_facecolor("#8E9BA0")
		sentiment_counts.plot(kind='pie', color=['green', 'red', 'grey'])
		plt.title('Sentiment Distribution of Comments')
		plt.savefig('/home/mano2708u/Intern/CommentsAnalyzer/src/templates/static/images/3.png')